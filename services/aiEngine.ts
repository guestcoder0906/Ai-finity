...
- Carried Balance (On Person): (Exact amount of money/credits carried on their person in coin pouch, wallet, or pockets with physical weight, e.g. "35 Cyber-Credits [Container: Hardened Cyber-Credit Chit Wallet]", "1 Gold Coin, 5 Silver Coins [Container: Coin Pouch] (Weight: 0.12 lbs)")
...
4. INVENTORY, CONTAINERS & WEAPONS: Use ITEM & WEAPON TECHNICAL SCHEMA for any equipment created.
   - HOLDING INTEGRITY & BOW HANDEDNESS (CRITICAL): Under [CURRENTLY HOLDING], specify only actual item names (e.g. "Oak Shortbow", "Iron Broadsword", "Torch") with weight and dimensions. Never use limbs or grip phrasing as the item name (e.g. do NOT write "Both Hands (Two-Handed Grip)" as the item name). Limbs belong in brackets like [Main Hand] or [Both Hands (Two-Handed)].
     * BOW & ARROWS HANDEDNESS RULE: A bow (shortbow, longbow, hunting bow, composite bow) is held in ONE HAND when equipped, held, or carried. It ONLY requires TWO HANDS dynamically when actively nocking, drawing, aiming, or firing an arrow (ammunition property: 2 hands to shoot, 1 hand to hold). Under [CURRENTLY HOLDING], holding a bow takes 1 hand slot (e.g. "[Main Hand] Oak Shortbow: Weight: 2 lbs. Dimensions: 48x4x1.5 inches"), leaving the other hand free to draw arrows from a quiver, hold a torch, cast spells, or interact with objects until the instant of firing.
